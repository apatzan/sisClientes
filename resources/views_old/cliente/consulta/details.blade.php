		...
		<div class="table-responsive">
			<table class="table table-striped table-bordered table-condensed table-hover">
				<thead>					
					...
					<th style="width: 150px;">Saldo Total</th>
...
{!!Form::open(array('url'=>'gestion/alta','method'=>'POST','autocomplete'=>'off'))!!}
            ...
            <div class="form-group">
            	...
            	<select name="idTipif" id="idTipif" class="form-control" data-live-search="true" style="width: 680px;">
...
{!!Form::open(array('url'=>'promesa/alta','method'=>'POST','autocomplete'=>'off'))!!}
            ...
            <div class="form-group">
                ...
                <!--<input type="text" name="observacion" class=form-control" placeholder="Ingrese Observación">-->
                <input class="date form-control" type="text" style="width: 680px;" name="fechaPromesa" required >
             </div>
...
{!!Form::open(array('url'=>'recordatorio/alta','method'=>'POST','autocomplete'=>'off'))!!}
            ...
            <div class="form-group">
                ...
                <!--<input type="text" name="observacion" class=form-control" placeholder="Ingrese Observación">-->
                <input class="date form-control" type="text" name="fechaPromesa" style="width: 680px;" required>
             </div>
             <script type="text/javascript">
