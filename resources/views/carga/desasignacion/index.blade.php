...
@section ('contenido')
  ...
  <div class="row">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <h3 style="width: 680px;">Desasignación de Cuentas</h3>



     <form method="post" enctype="multipart/form-data" action="{{ url('/carga/desasignacion/import') }}">
    {{ csrf_field() }}
     ...
     <table class="table">
      <tr>
       ...
       <td width="30%" align="left">
        <input type="submit" name="upload" class="btn btn-primary" value="Procesar desasignación">
       </td>
      </tr>
      <tr>
