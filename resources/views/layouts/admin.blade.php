    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-mini"><b>GLB COLLECTION</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>GLB COLLECTION</b></span>
        </a>
           ...
           <!--     <li><a href="gestion/tipificacion"><i class="fa fa-circle-o"></i> Consulta</a></li> -->
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="{{url('gestion/reportegeneral')}}"><i class="fa fa-circle-o"></i> Gestiones por fecha</a></li>
